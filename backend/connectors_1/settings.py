"""
Django settings for connectors_1 project.
...
ROOT_URLCONF = 'connectors_1.urls'
...
WSGI_APPLICATION = 'connectors_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "connectors_1 API",
    "DESCRIPTION": "API documentation for connectors_1 App",
    "VERSION": "v1",
}
